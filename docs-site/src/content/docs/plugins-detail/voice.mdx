...
- **[Hex](https://github.com/kitlangton/Hex)**
  (macOS only, open-source) — highly recommended.
  Faster and more accurate transcriptions with no
  stuttering.
- **[Handy](https://github.com/cjpais/Handy)**
  (open-source) — uses the **Parakeet V3** model.
  Stunningly fast, near-instant transcription,
  though may occasionally stutter.
